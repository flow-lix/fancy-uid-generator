...
import static learn.platform.common.constant.LeafConstant.EXCEPTION_IDCACHE_INIT_FALSE;
import static learn.platform.common.constant.LeafConstant.EXCEPTION_IDCACHE_KEY_NOT_EXISTED;
...
public class SegmentServiceImpl implements LeafService {
    ...
    private void updateSegmentFromDb(String tag, Segment current) {
        ...
        if (!buffer.isInitialized()) {
            ...
            idAlloc = idAllocMapper.getIdAlloc(tag);
